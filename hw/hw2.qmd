...
From [3.4.d. (Part 1.)](#sec-3-4-d), and let $c$ be the scale factor of $p(\theta)\times p(y|\theta)$

\begin{align}
  1 &= \int^{1}_{0} cp(\theta)\times p(y|\theta) d\theta\\
  1 &= \int^{1}_{0} c \times \frac{1}{4}\frac{\Gamma(10)}{\Gamma(2)\Gamma(8)}\frac{\Gamma(44)}{\Gamma(16)\Gamma(29)}(\theta^{22}(1-\theta)^{29} + 3\theta^{16}(1-\theta)^{35}) d\theta\\ 
  \frac{1}{4}\frac{\Gamma(10)}{\Gamma(2)\Gamma(8)}\frac{\Gamma(44)}{\Gamma(16)\Gamma(29)} \frac{1}{c} &= \int^{1}_{0} (\theta^{22}(1-\theta)^{29} + 3\theta^{16}(1-\theta)^{35})\theta\\ 
  \frac{1}{4}\frac{\Gamma(10)}{\Gamma(2)\Gamma(8)}\frac{\Gamma(44)}{\Gamma(16)\Gamma(29)} \frac{1}{c} &= \int^{1}_{0} (\theta^{22}(1-\theta)^{29} d\theta + \int^{1}_{0}  3\theta^{16}(1-\theta)^{35}) d\theta\\ 
  \frac{1}{4}\frac{\Gamma(10)}{\Gamma(2)\Gamma(8)}\frac{\Gamma(44)}{\Gamma(16)\Gamma(29)} \frac{1}{c} &= \int^{1}_{0} (\theta^{23-1}(1-\theta)^{30-1} d\theta + 3\int^{1}_{0} \theta^{17-1}(1-\theta)^{36-1} d\theta\\ 
  \frac{1}{4}\frac{\Gamma(10)}{\Gamma(2)\Gamma(8)}\frac{\Gamma(44)}{\Gamma(16)\Gamma(29)} \frac{1}{c} &= \frac{\Gamma(23)\Gamma(30)}{\Gamma(53)} + 3\frac{\Gamma(17)\Gamma(36)}{\Gamma(51)}\\
\end{align}
...
- $Y_2$ is dependent on $Y_1$, and $Y_1$ gives information about $\theta$. $\theta$ is needed to provide the predictive distribution over $Y_2$.
- Assume $Y_2$ is binomial distribution. 
